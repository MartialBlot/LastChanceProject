...
export class GameService {
	...
	moveLeft = false;
	moveRight = false;
spaceshipPath = '../assets/images/widowMaker.png';
ennemyPath = '../assets/images/vaisseauennemi.png';
asteroidPath = '../assets/images/asteroids.png';
	loadAssets(canvasElement: HTMLCanvasElement): Promise<void>  {
		...
		return new Promise((resolve, reject) => {
			...
			this.image.src = CONFIG.spaceshipPath;
			this.image.width = 58;
